...
public class Main {
    public static void main(String[] args) {
        ...
        /**Добавляем с помощью анонимного класса*/
        //экземпляр анон. класса, который реализует ElecticStuff, и переопределяет elecricityOn
        ...
        /**Добавляем просто с помощью ссылки на метод*/
        station.addElectricStuff(System.out::println);
